...
_TUTORIAL_DATA_EN = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "Use the Enhance card for Photoshop-style fixes: tick 'Auto enhance' for a one-click correction, or set exposure, dehaze, vibrance, clarity, noise reduction and unsharp-mask sharpening.",
            "For local edits, open Local Adjustments (Masks): click 'Add mask' and pick a type — Radial (a rotatable ellipse), Linear gradient, Color range (eyedropper), Luminance range (select by brightness), or Brush (paint freehand on the preview). Place it, then adjust only that area — including clarity, dehaze, sharpen and blur. Use Combine (Subtract / Intersect) to build precise selections from several masks, and tick 'Show mask overlay' to see exactly what each mask selects.",
        ...
        "tips": [
            "The editor is organized into sub-tabs — Transform, Color, Enhance, Masks, Presets, Wallpaper — switch them from the bar at the top. Input, preview and output stay visible on every tab.",
            "The Color tab has a Tone Curve — drag points to reshape highlights/midtones/shadows, click empty space to add a point, double-click to remove one. Every edit is undoable with Ctrl+Z (Ctrl+Y to redo).",
            ...
            "Enhance tips: Vibrance protects skin tones better than Saturation; Clarity adds local-contrast punch; Dehaze rescues flat, hazy shots.",
            "Masks are non-destructive and stack in order — Invert flips a mask, Opacity dials its whole effect up or down, and raising Feather gives a soft, seamless blend.",
...
_TUTORIAL_DATA_AR = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "استخدم بطاقة 'التحسين' لإصلاحات بأسلوب فوتوشوب: فعّل 'تحسين تلقائي' لإصلاح بنقرة واحدة، أو اضبط التعريض وإزالة الضباب والحيوية والوضوح وتقليل التشويش وحدّة قناع عدم الحدّة.",
            "للتعديلات الموضعية افتح 'تعديلات موضعية (أقنعة)': انقر 'إضافة قناع' واختر نوعاً — دائري (إهليلج قابل للتدوير)، تدرّج خطّي، نطاق لوني (قطّارة)، نطاق إضاءة (تحديد حسب السطوع)، أو فرشاة (ارسم بحرّية على المعاينة). ضعه ثم عدّل تلك المنطقة فقط — بما فيها الوضوح وإزالة الضباب والحدّة والضبابية. استخدم 'الدمج' (طرح / تقاطع) لبناء تحديدات دقيقة من عدة أقنعة، وفعّل 'إظهار طبقة القناع' لترى ما يحدّده كل قناع بالضبط.",
        ...
        "tips": [
            "المحرر منظَّم في تبويبات فرعية — تحويل، ألوان، تحسين، أقنعة، إعدادات مسبقة، خلفية — بدّل بينها من الشريط في الأعلى. الإدخال والمعاينة والإخراج تبقى ظاهرة في كل تبويب.",
            "تبويب الألوان فيه منحنى تدرّج — اسحب النقاط لإعادة تشكيل الإبرازات والدرجات الوسطى والظلال، انقر مكاناً فارغاً لإضافة نقطة، وانقر مزدوجاً لحذفها. كل تعديل قابل للتراجع بـ Ctrl+Z (والإعادة بـ Ctrl+Y).",
            ...
            "نصائح التحسين: 'الحيوية' تحمي ألوان البشرة أفضل من 'التشبع'؛ 'الوضوح' يضيف قوة التباين المحلي؛ 'إزالة الضباب' تنقذ الصور الباهتة والضبابية.",
            "الأقنعة غير إتلافية وتتراكم بالترتيب — 'عكس' يقلب القناع، و'العتامة' ترفع أثره كاملاً أو تخفضه، ورفع 'تنعيم الحواف' يعطي مزجاً ناعماً وسلساً.",
