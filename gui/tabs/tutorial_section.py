...
_TUTORIAL_DATA_EN = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "Optional: Protected Ranges — list time ranges (one per line, 'start - end') that must be kept intact. Silence inside them is preserved.",
        ...
        "tips": [
            ...
            "Protected Ranges accept seconds (90-120), M:SS (1:30-2:00), or H:MM:SS. Use '#' for comments.",
...
_TUTORIAL_DATA_AR = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "اختياري: نطاقات محمية — أدخل نطاقات زمنية (سطر لكل نطاق، 'البداية - النهاية') يجب الإبقاء عليها كما هي. الصمت داخلها يُحفظ.",
        ...
        "tips": [
            ...
            "النطاقات المحمية تقبل الثواني (90-120) أو د:ث (1:30-2:00) أو س:د:ث. استخدم '#' للتعليقات.",
