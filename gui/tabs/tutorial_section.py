...
_TUTORIAL_DATA_EN = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "For local edits, open Local Adjustments (Masks): click 'Add mask', pick Radial, Linear gradient, or Color range. Radial/Linear: drag on the preview to place. Color range: use the eyedropper to click a color (sky, grass) and set a tolerance — then adjust only that area. Stack several masks for pro-style selective editing.",
        ...
        "tips": [
            ...
            "Masks are non-destructive and stack in order — Invert flips a mask to edit everything outside it; raise Feather for a soft, seamless blend.",
...
_TUTORIAL_DATA_AR = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "للتعديلات الموضعية افتح 'تعديلات موضعية (أقنعة)': انقر 'إضافة قناع'، اختر دائري أو تدرّج خطّي أو نطاق لوني. الدائري/الخطّي: اسحب على المعاينة لوضعه. النطاق اللوني: استخدم القطّارة لاختيار لون (سماء، عشب) واضبط التسامح — ثم عدّل تلك المنطقة فقط. كدّس عدة أقنعة لتحرير انتقائي احترافي.",
        ...
        "tips": [
            ...
            "الأقنعة غير إتلافية وتتراكم بالترتيب — 'عكس' يقلب القناع لتعديل كل ما هو خارجه؛ ارفع 'تنعيم الحواف' لمزج ناعم وسلس.",
